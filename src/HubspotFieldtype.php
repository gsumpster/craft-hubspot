...
namespace gsumpster\hubspotfieldtype;

use gsumpster\hubspotfieldtype\services\Form as FormService;
use gsumpster\hubspotfieldtype\models\Settings;
use gsumpster\hubspotfieldtype\fields\Form as FormField;
 ...
 */
class HubspotFieldtype extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->setComponents([
            'FormService' => \gsumpster\hubspotfieldtype\services\Form::class,
        ]);
