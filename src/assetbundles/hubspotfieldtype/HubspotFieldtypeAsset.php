...
namespace gsumpster\hubspotfieldtype\assetbundles\hubspotfieldtype;
...
/**
 * HubspotFieldtypeAsset AssetBundle
 *
 ...
 * @since     0.1.0
 */
class HubspotFieldtypeAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@gsumpster/hubspotfieldtype/assetbundles/hubspotfieldtype/dist";
        ...
        $this->js = [
            'js/HubspotFieldtype.js',
        ];

        $this->css = [
            'css/HubspotFieldtype.css',
        ];
