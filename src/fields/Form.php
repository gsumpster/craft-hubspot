...
namespace gsumpster\hubspotfieldtype\fields;

use gsumpster\hubspotfieldtype\HubspotFieldtype;
use gsumpster\hubspotfieldtype\assetbundles\formfield\FormFieldAsset;
...
class Form extends Field
{
    ...
    {
        return Craft::t('hubspot-fieldtype', 'Hubspot Form');
    }
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(FormFieldAsset::class);
        ...
        return Craft::$app->getView()->renderTemplate(
            'hubspot-fieldtype/_components/fields/Form_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
